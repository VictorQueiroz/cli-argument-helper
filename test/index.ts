    ...
    describe("getBoolean", () => {
      describe("true", () => {
        it("should return true from --props.user.id=true argument", () => {
          ...
          expect(getNamedArgument(args, "--props.user.id", getBoolean)).to.be
            .true;
          expect(args).to.be.deep.equal([]);
        });
  ...
  describe("number", () => {
    ...
    describe("getFloat", () => {
      ...
      test(`it should get float from --user.id ${Math.PI}`, async () => {
        ...
        expect(getNamedArgument(args, "--user.id", getFloat)).to.be.equal(
          Math.PI,
        );
        expect(args).to.be.deep.equal([]);
      });
    ...
    describe("getOctal", () => {
      it("should get octal from --user.id 0o30000", async () => {
        ...
        expect(getNamedArgument(args, "--user.id", getOctal)).to.be.equal(
          0o30000,
        );
        expect(args).to.be.deep.equal([]);
      });
    ...
    describe("getBinary", () => {
      it("should get binary from --user.id 0b110", async () => {
        ...
        expect(getNamedArgument(args, "--user.id", getBinary)).to.be.equal(
          0b110,
        );
        expect(args).to.be.deep.equal([]);
      });
    ...
    describe("getInteger", () => {
      ...
      it("should return null in case validation fails", () => {
        ...
        expect(getNamedArgument(args, "--user-id", getInteger)).to.be.equal(
          null,
        );
      });
